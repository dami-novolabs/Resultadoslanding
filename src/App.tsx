      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl tracking-tight mb-4 sm:mb-6 leading-[1.2]" style={{ fontWeight: 800 }}>
            ...
            <span className="block text-[rgb(255,58,32)] whitespace-nowrap text-[48px]" style={{ fontFamily: 'Geist, sans-serif' }}>
              lanzar tu proyecto
            </span>
          </h1>
          ...
          >
            Agendar entrevista<br />(luego de ver el video)
          </a>
        </motion.div>
        ...
        <div className="relative overflow-visible">
          ...
          {!isVideoPlaying && (
            ...
            >
              {/* Name Text */}
              <p 
                className="text-base text-white mb-2 text-left"
              ...
              {/* Curved Arrow SVG - upward curve from text to video */}
              <svg
                width="240"
                height="120"
                viewBox="0 0 240 120"
              ...
              >
                {/* Arrow path - curves upward from bottom-left to top-right */}
                <motion.path
